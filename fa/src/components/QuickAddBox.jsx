...
const APPS = [
  {
    ...
    note: 'اگه Streisand نصب باشه، اشتراک خودکار اضافه می‌شه. اگه اضافه نشد، لینک از قبل کپی شده - از + و Import from Clipboard استفاده کن.'
  },
  {
    id: 'v2rayng',
    label: 'V2rayNG',
    ...
    note: 'اگه V2rayNG نصب باشه، اشتراک خودکار اضافه می‌شه.'
  },
  {
    id: 'v2box',
    label: 'V2Box',
    ...
    note: 'اگه V2Box نصب باشه، اشتراک خودکار اضافه می‌شه.'
  },
  {
    id: 'v2raytun',
    label: 'V2RayTun',
    ...
    note: 'اگه V2RayTun نصب باشه، اشتراک خودکار اضافه می‌شه.'
  },
  {
    id: 'happ',
    label: 'Happ',
    ...
    note: 'اگه Happ نصب باشه، اشتراک خودکار اضافه می‌شه.'
  }
];
  ...
  return (
    <GlowCard className="p-6">
      <Typography variant="subtitle1" sx={{ fontWeight: 700, color: '#FAFAFA', mb: 0.5 }}>
        افزودن سریع به اپلیکیشن
      </Typography>
      <Typography variant="caption" sx={{ color: 'rgba(250,250,250,0.45)', display: 'block', mb: 2 }}>
        روی آیکون اپلیکیشنت بزن؛ لینک اشتراک کپی می‌شه و اپ باز می‌شه.
      </Typography>
        ...
        {APPS.map((app) => (
          <Tooltip key={app.id} title={app.note}>
            <button
              ...
              aria-label={`افزودن سریع به ${app.label}`}
